...
public class VectorToRaster {
    ...
    public static GridCoverageBuilder2 rasterFactory = new GridCoverageBuilder2();
     ...
     * @exception  FeatureRasterizerException  Description of the Exception
     */
    public VectorToRaster(float noData) {
        this(800, 800, noData);
    }
     ...
     */
    public VectorToRaster(int height, int width) {
     ...
     * @param  noData                         No Data value for raster
     */
    public VectorToRaster(int height, int width, float noData) {
        this.height = height;
        this.width = width;
...
//      System.out.println("IMAGE ACCELERATED? "+bimage.getCapabilities(ge.getDefaultScreenDevice().getDefaultConfiguration()).isAccelerated());
    ...
    public GridCoverage rasterize(String name, Geometry geom,String attributeName) {
    	if (raster == null) {
    ...
    public GridCoverage rasterize(String name, FeatureCollection fc, String attributeName, ReferencedEnvelope env) throws FeatureRasterizerException {
