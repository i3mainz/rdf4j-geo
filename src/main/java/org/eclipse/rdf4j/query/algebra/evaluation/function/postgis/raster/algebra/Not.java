...
public class Not extends RasterAlgebraUnaryFunction {

	@Override
	public String getURI() {
		return POSTGIS.ST_rast_algebra_not.stringValue();
	}
	...
	public GridCoverage modify(GridCoverage raster,Integer rd1) {
		...
		RenderedOp subtractedImage = JAI.create("not", pbSubtracted);
		/*
		...
		final SampleDimension sd = new SampleDimension.Builder().setName("t")
				.addQuantitative(
						(raster.getSampleDimensions().get(rd1).getName() + "not").toString(),
