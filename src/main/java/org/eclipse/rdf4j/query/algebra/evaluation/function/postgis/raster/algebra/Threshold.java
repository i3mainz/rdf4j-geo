...
public class Threshold extends RasterAlgebraFunction{

	@Override
	public String getURI() {
		return POSTGIS.ST_rast_algebra_threshold.stringValue();
	}
	...
	public GridCoverage modify(GridCoverage raster, Integer rd1, GridCoverage raster2, Integer rd2) {
		...
		RenderedOp subtractedImage = JAI.create("threshold", pbSubtracted);
