...
public class Mean extends RasterAlgebraFunction {

	@Override
	public String getURI() {
		return POSTGIS.ST_rast_algebra_mean.stringValue();
	}
	...
	public GridCoverage modify(GridCoverage raster,Integer rd1,GridCoverage raster2,Integer rd2) {
		...
		RenderedOp subtractedImage = JAI.create("mean", pbSubtracted);
		/*
		...
		final SampleDimension sd = new SampleDimension.Builder().setName("t")
				.addQuantitative(
						(raster.getSampleDimensions().get(rd1).getName() + "mean"
