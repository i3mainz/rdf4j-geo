...
public class LocateAlong extends GeometricModifierDoubleFunction {

	@Override
	public String getURI() {
		return POSTGIS.st_locateAlong.stringValue();
	}

	@Override
	protected Geometry relation(Geometry geom, Double mvalue) {
		GeometryFactory fac=new GeometryFactory();
		List<Coordinate> resultpoint=new LinkedList<Coordinate>();
		for(Coordinate coord:geom.getCoordinates()) {
			if(coord.getM()==mvalue) {
