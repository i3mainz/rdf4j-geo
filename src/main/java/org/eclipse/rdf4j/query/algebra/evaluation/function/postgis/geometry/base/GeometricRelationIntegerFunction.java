...
public abstract class GeometricRelationIntegerFunction implements Function {
	...
	public Value evaluate(ValueFactory valueFactory, Value... args) throws ValueExprEvaluationException {
		...
		if(l instanceof VectorLiteral && l2 instanceof VectorLiteral) {
			...
			double result = relation(geom,transformed);
	...
	protected abstract int relation(Geometry g1, Geometry g2);
