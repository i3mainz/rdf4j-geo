...
public abstract class RasterAttributeIntIntIntIntFunction implements Function {
	...
	public Value evaluate(ValueFactory valueFactory, Value... args) throws ValueExprEvaluationException {
		...
		if(l instanceof RasterLiteral) {
			...
			Integer result = attribute(geom,noband,x,y);
			return valueFactory.createLiteral(result);
		}
		return null;
	}
	
	public abstract Integer attribute(GridCoverage geom,Integer noband,Integer x,Integer y);
