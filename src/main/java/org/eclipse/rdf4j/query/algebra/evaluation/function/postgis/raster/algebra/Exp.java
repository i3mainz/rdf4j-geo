...
public class Exp extends RasterAlgebraUnaryFunction {

	@Override
	public String getURI() {
		return POSTGIS.ST_rast_algebra_exp.stringValue();
	}
	...
	public GridCoverage modify(GridCoverage raster,Integer rd1) {
		...
		RenderedOp subtractedImage = JAI.create("exp", pbSubtracted);
		/*
		...
		final SampleDimension sd = new SampleDimension.Builder().setName("t")
				.addQuantitative(
						(raster.getSampleDimensions().get(rd1).getName() + "exp").toString(),
