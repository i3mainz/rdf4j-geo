...
public class SridGetAxis1Name extends GeometricStringExportFunction {

	@Override
	public String getURI() {
		return POSTGIS.SRIDGetAxis1Name.stringValue();
	}
	...
	public String operation(Geometry geom) {
		...
		try {
			...
			return crs.getCoordinateSystem().getAxis(0).getName().toString();
