...
public abstract class GeometricRelationDoubleDoubleFunction implements Function {
	...
	public Value evaluate(ValueFactory valueFactory, Value... args) throws ValueExprEvaluationException {
		...
		if(l instanceof VectorLiteral && l2 instanceof VectorLiteral) {
			...
			double result = relation(geom,transformed,value);
	...
	protected abstract double relation(Geometry g1, Geometry g2,Double value);
