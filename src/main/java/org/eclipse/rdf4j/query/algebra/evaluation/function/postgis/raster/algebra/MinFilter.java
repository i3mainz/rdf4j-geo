...
public class MinFilter extends RasterAlgebraUnaryFunction {

	@Override
	public String getURI() {
		return POSTGIS.ST_rast_algebra_minfilter.stringValue();
	}
	...
	public GridCoverage modify(GridCoverage raster,Integer rd1) {
		...
		final SampleDimension sd = new SampleDimension.Builder().setName("t")
				.addQuantitative(
						(raster.getSampleDimensions().get(rd1).getName() + "minfilter"),
