...
public class MedianFilter extends RasterAlgebraUnaryFunction {
	...
	public String getURI() {
		return POSTGIS.ST_rast_algebra_medianfilter.stringValue();
	}
	...
	public GridCoverage modify(GridCoverage raster,Integer rd1) {
		...
		RenderedOp subtractedImage = JAI.create("medianfilter", pbSubtracted);
		/*
		...
		final SampleDimension sd = new SampleDimension.Builder().setName("t")
				.addQuantitative(
						(raster.getSampleDimensions().get(rd1).getName() + "medianfilter"),
