...
public abstract class RasterAttributeDoubleIntFunction implements Function {
...
public Value evaluate(ValueFactory valueFactory, Value... args) throws ValueExprEvaluationException {
	...
	if(l instanceof RasterLiteral) {
		...
		Double result = attribute(geom,parameter);
		return valueFactory.createLiteral(result);
	}
	return null;
}

public abstract Double attribute(GridCoverage geom,Integer param);
