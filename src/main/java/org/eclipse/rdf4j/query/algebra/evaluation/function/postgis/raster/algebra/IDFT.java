...
public class IDFT extends RasterAlgebraFunction {

	@Override
	public String getURI() {
		return POSTGIS.ST_rast_algebra_idft.stringValue();
	}
	...
	public GridCoverage modify(GridCoverage raster,Integer rd1,GridCoverage raster2,Integer rd2) {
		...
		RenderedOp subtractedImage = JAI.create("idft", pbSubtracted);
		/*
		...
		final SampleDimension sd = new SampleDimension.Builder().setName("t")
				.addQuantitative(
						(raster.getSampleDimensions().get(rd1).getName() + "idft"
