...
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.envelope.relation.BBOXIntersects;
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.util.literals.vector.WKTDatatype;
import org.junit.jupiter.api.Test;

public class BBOXIntersectsTest {
...
public static final String testGeom1="LINESTRING (1 4, 1 7)";
	...
	@Test
	public void testBBOXIntersectsTrue() {
		BBOXIntersects instance=new BBOXIntersects();
	...
	@Test
	public void testBBOXIntersectsFalse() {
		BBOXIntersects instance=new BBOXIntersects();
		ValueFactory valfac=SimpleValueFactory.getInstance();
		Value geo=valfac.createLiteral(testGeom1, WKTDatatype.LiteralIRI);
		Value geo2=valfac.createLiteral(testGeom2, WKTDatatype.LiteralIRI);
