...
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.envelope.relation.BBOXContains;
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.util.literals.vector.WKTDatatype;
import org.junit.jupiter.api.Test;

public class BBOXContainsTest {
	...
	@Test
	public void testBBOXContainsTrue() {
		BBOXContains instance=new BBOXContains();
	...
	@Test
	public void testBBOXContainsFalse() {
		BBOXContains instance=new BBOXContains();
		ValueFactory valfac=SimpleValueFactory.getInstance();
		Value geo=valfac.createLiteral(testGeom1, WKTDatatype.LiteralIRI);
		Value geo2=valfac.createLiteral(testGeom2, WKTDatatype.LiteralIRI);
