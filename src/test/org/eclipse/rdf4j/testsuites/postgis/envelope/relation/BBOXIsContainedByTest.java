...
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.envelope.relation.BBOXIsContainedBy;
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.util.literals.vector.WKTDatatype;
import org.junit.jupiter.api.Test;

public class BBOXIsContainedByTest {
	...
	@Test
	public void testBBOXIsContainedByTrue() {
		BBOXIsContainedBy instance=new BBOXIsContainedBy();
	...
	@Test
	public void testBBOXIsContainedByFalse() {
		BBOXIsContainedBy instance=new BBOXIsContainedBy();
		ValueFactory valfac=SimpleValueFactory.getInstance();
		Value geo=valfac.createLiteral(testGeom1, WKTDatatype.LiteralIRI);
		Value geo2=valfac.createLiteral(testGeom2, WKTDatatype.LiteralIRI);
