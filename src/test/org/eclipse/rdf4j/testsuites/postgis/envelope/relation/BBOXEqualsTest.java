...
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.envelope.relation.BBOXEquals;
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.util.literals.vector.WKTDatatype;
import org.junit.jupiter.api.Test;

public class BBOXEqualsTest {
	...
	@Test
	public void testBBOXEqualsTrue() {
		BBOXEquals instance=new BBOXEquals();
	...
	@Test
	public void testBBOXEqualsFalse() {
		BBOXEquals instance=new BBOXEquals();
		ValueFactory valfac=SimpleValueFactory.getInstance();
		Value geo=valfac.createLiteral(testGeom1, WKTDatatype.LiteralIRI);
