...
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.polygon.attribute.IsRightTriangle;
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.util.literals.vector.WKTDatatype;
import org.junit.jupiter.api.Test;

public class IsRightTriangleTest {

	public static final String testPolygon="POLYGON((8 6, -10 -12, 0 14, 8 6))";
	
	public static final String testPolygon2="POLYGON((1 2, 3 4, 5 6, 1 2))";
	
	@Test
	public void testIsRightTriangleFalse() {
		IsRightTriangle instance=new IsRightTriangle();
