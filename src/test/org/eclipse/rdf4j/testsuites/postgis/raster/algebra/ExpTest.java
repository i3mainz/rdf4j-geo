...
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.raster.algebra.Exp;
...
public class ExpTest extends SampleRasters {
	...
	public void testExp() {
        ...
        Value result= instance.evaluate(valfac,cov1,valfac.createLiteral(0));
