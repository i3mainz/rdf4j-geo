...
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.raster.attribute.BandNoDataValue;
...
public class BandNoDataValueTest extends SampleRasters {
	
	@Test
	public void testBandNoDataValue() {
		ValueFactory valfac=SimpleValueFactory.getInstance();
        Value cov1 = valfac.createLiteral(wkbString1, HexWKBRastDatatype.LiteralIRI);
        Value bandno = valfac.createLiteral(1);
        BandNoDataValue instance=new BandNoDataValue();
