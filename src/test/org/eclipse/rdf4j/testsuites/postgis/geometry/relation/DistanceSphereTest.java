...
import org.eclipse.rdf4j.query.algebra.evaluation.function.postgis.geometry.relation.DistanceSphere;
...
public class DistanceSphereTest {
	...
	public void testDistanceSphere2() {
		...
		Value result=instance.evaluate(valfac, geo,geo2);
		Value expResult=valfac.createLiteral(7269372.186370237e0);
		assertEquals(expResult, result);
	}
